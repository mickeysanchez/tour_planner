...
module PostgreSQL
  ...
  class BatchHelperVersion8 < Choreography

    ####
    #  Create a new instance of the BatchHelperVersion8 Choreo. A TembooSession object, containing a valid
    #  set of Temboo credentials, must be supplied.
    ####
    def initialize(session)
      super(session, "/Library/PostgreSQL/BatchHelperVersion8")
    end

    #### 
    # Obtain an InputSet object, used to define inputs for an execution of this Choreo.
    #
    # @return BatchHelperVersion8InputSet
    ####
    def new_input_set()
      return BatchHelperVersion8InputSet.new()
    end

    def make_result_set()
      return BatchHelperVersion8ResultSet.new()
    end
    ...
    def execute(input_set = nil)
      ...
      results = BatchHelperVersion8ResultSet.new(resp)
      return results
    end

    ####
    # An InputSet with methods appropriate for specifying the inputs to the BatchHelperVersion8
    # Choreo. The InputSet object is used to specify input parameters when executing this Choreo.
    ####
    class BatchHelperVersion8InputSet < Choreography::InputSet

      #### 
      # Set the value of the FormattedXML input for this Choreo. 
      # 
      # @param String - (required, xml) 
      ###

      def set_FormattedXML(value)
        set_input("FormattedXML", value)
      end
      #### 
    ...
    ####
    # A ResultSet with methods tailored to the values returned by the BatchHelperVersion8 Choreo.
    # The ResultSet object is used to retrieve the results of a Choreo execution.
    ####
    class BatchHelperVersion8ResultSet < Choreography::ResultSet
    	####
  ...
  class BatchHelperVersion9 < Choreography

    ####
    #  Create a new instance of the BatchHelperVersion9 Choreo. A TembooSession object, containing a valid
    #  set of Temboo credentials, must be supplied.
    ####
    def initialize(session)
      super(session, "/Library/PostgreSQL/BatchHelperVersion9")
    end

    #### 
    # Obtain an InputSet object, used to define inputs for an execution of this Choreo.
    #
    # @return BatchHelperVersion9InputSet
    ####
    def new_input_set()
      return BatchHelperVersion9InputSet.new()
    end

    def make_result_set()
      return BatchHelperVersion9ResultSet.new()
    end
    ...
    ####
    # An InputSet with methods appropriate for specifying the inputs to the BatchHelperVersion9
    # Choreo. The InputSet object is used to specify input parameters when executing this Choreo.
    ####
    class BatchHelperVersion9InputSet < Choreography::InputSet
    ...
    ####
    # A ResultSet with methods tailored to the values returned by the BatchHelperVersion9 Choreo.
    # The ResultSet object is used to retrieve the results of a Choreo execution.
    ####
    class BatchHelperVersion9ResultSet < Choreography::ResultSet
    	####
    	# Retrieve the value for the "Success" output from this Choreo execution
    	#
    	# @return String - (boolean) Indicates the result of the batch operation. The value will be "true" when the SQL transaction executes successfully.
  ...
  class JSONToDB < Choreography
    ...
    ####
    def initialize(session)
      super(session, "/Library/PostgreSQL/JSONToDB")
    end
  ...
  class RunCommand < Choreography
    ...
    ####
    def initialize(session)
      super(session, "/Library/PostgreSQL/RunCommand")
    end
  ...
  class XMLToDB < Choreography
    ...
    ####
    def initialize(session)
      super(session, "/Library/PostgreSQL/XMLToDB")
    end
