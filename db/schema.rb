...
ActiveRecord::Schema.define(:version => 20140226235437) do
  ...
  add_index "band_memberships", ["active"], :name => "index_band_memberships_on_active"
  ...
  add_index "tours", ["active"], :name => "index_tours_on_active"
